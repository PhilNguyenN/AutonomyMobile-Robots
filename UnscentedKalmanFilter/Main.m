...
% Count the value of sensor and command comming data 
c_sensor = 2;
c_command= 1;

% Initial time and tracking time
t=0;
last_t = 0;

% Find the maximum time in the dataset
...
while t<t_max
   ...
   if t>t_command
       ...
       [mean_bar, sigma_bar] = UKF_Prediction(mean_t_1, sigma_t_1, command_data (:, c_command), delta_t);
       mean_t_1 = mean_bar;
       sigma_t_1 = sigma_bar;
   ...
   elseif t>t_sensor
       ...
       [mean_bar, sigma_bar] = UKF_Prediction(mean_t_1, sigma_t_1, command_data (:, c_command), delta_t);
       [mean, sigma] = UKF_Correction(mean_bar,sigma_bar,sensor_data(:,c_sensor),t_sensor);
